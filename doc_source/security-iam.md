...
**IAM administrator** – If you're an IAM administrator, you might want to learn details about how you can write policies to manage access to AWS Mainframe Modernization\. To view example AWS Mainframe Modernization identity\-based policies that you can use in IAM, see [Identity\-based policy examples for AWS Mainframe Modernization](security_iam_id-based-policy-examples.md)\.
